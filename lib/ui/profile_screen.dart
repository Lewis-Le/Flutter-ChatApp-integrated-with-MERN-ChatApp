...
class ProfileScreen extends StatefulWidget {
  ...
  final dynamic userData; //data dạng obj của user hiện tại
...
class ProfileScreenState extends State<StatefulWidget> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          buildName(user, 'lewis@lewis.com'),
          const SizedBox(height: 24),
  ...
  Widget buildImage() {
    final image = NetworkImage(userData['avatar']);
    return ClipOval(
      child: Material(
